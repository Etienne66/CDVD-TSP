//Original from https://github.com/NVIDIA/flownet2-pytorch
// https://github.com/NVIDIA/flownet2-pytorch/tree/master/networks/resample2d_package
...
__global__ void kernel_resample2d_update_output(
    const int n, 
    const scalar_t* __restrict__ input1,
    const long4 input1_size,
    const long4 input1_stride,
    const scalar_t* __restrict__ input2,
    const long4 input2_size,
    const long4 input2_stride, 
...
__global__ void kernel_resample2d_backward_input1(
    ...
    const long4 gradOutput_size,
    const long4 gradOutput_stride,
    scalar_t* __restrict__ gradInput,
    const long4 gradInput_size,
    const long4 gradInput_stride,
    const int kernel_size,
    bool bilinear) {
